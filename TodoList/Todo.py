...
def save_act():
    ...
    if savecon.upper() == "YES":
        with open("TodoSaveFile.txt", "w") as filehandle:
...
def load_info():
    messagebox.showinfo(
        "info", "This is Todolist V.1.0 \n created by BHARGAV PRATIM SHARMA\n Python Project",)
...
# image_icon = PhotoImage(file="/home/bhargav/My_projects/app_container/appStore_images/todo.png")
